...
for (let i = 0; i < products.length; i++){
  temp +=`
   <div  class="box">
        <h1 class="t1">${products[i].title}title</h1>
        <p class="p1">${products[i].description}description</p>
        <p class="p1">${products[i].category}category</p>
        <p class="p1">${products[i].price}price</p>
        <p class="p1">${products[i].discountPercentage}discountpercentage</p>
